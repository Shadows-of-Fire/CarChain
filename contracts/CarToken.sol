...
contract CarToken is ERC721Enumerable, Ownable {
	...
	//Changes the manufacturer.  Only accessible by deployer/current owner.
    function setManufacturer(address addr) public onlyOwner {
        manufacturer = addr;
    }
	
	//Sets the car chain address.  Only accessible by deployer/current owner.
	...
	*/
	...
	//Public exposure of the _exists function, which checks if a token exists.
