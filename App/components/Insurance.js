...
class Insurance extends Component {
    ...
    insuranceInput = async (approve) => {
        await this.state.purchaseContract.methods.insnInput(approve).send({from:this.state.account})
    }
